...
namespace Gaskellgames.EditorOnly
{
    ...
    public class SceneDataDrawer : PropertyDrawer
    {
        ...
        public override float GetPropertyHeight(SerializedProperty property, GUIContent label)
        {
            ...
            {
                return GgGUI.singleLineHeight + GgGUI.standardSpacing;
            }
            ...
            return sceneAsset.objectReferenceValue == null
                ...
                : ((GgGUI.singleLineHeight + GgGUI.standardSpacing) * 5) + GgGUI.standardSpacing;
        }
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            label.tooltip = tooltipSuffix;
            bool guiEnabled = GUI.enabled;
            
            // draw header
            GgGUI.GetFoldoutPositionRects(position, label, out GgFoldoutPositions foldoutPositions);
