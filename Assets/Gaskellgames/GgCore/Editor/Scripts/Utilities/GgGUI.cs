...
namespace Gaskellgames.EditorOnly
{
    ...
    public static class GgGUI
    {
        ...
        public static void GetFoldoutPositionRects(Rect position, GUIContent label, out GgFoldoutPositions foldoutPositions)
        {
        ...
        public static void DrawDropdownHeader(GgFoldoutPositions foldoutPositions, SerializedProperty property, GUIContent label, bool fullWidth = true, bool bold = true)
        {
