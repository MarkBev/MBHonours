...
namespace Gaskellgames
{
    ...
    public class GgTaskTrackerEditorWindow : GgEditorWindow
    {
        ...
        {
            // banner
            EditorWindowUtility.TryDrawBanner(banner, true, false);
        ...
        {
            banner = EditorWindowUtility.LoadInspectorBanner(packageRefName_GgCore, relativePath_GgCore + "InspectorBanner_GgCore.png");
            TrackedTasksUpdated();
            InitialiseTable();
        }
